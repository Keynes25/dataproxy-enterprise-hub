        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  ...
                  <span>{t('services.cybersecurity.feature1')}</span>
                </li>
                <li className="flex items-start">
                  <div className="h-6 w-6 rounded-full bg-primary-100 flex items-center justify-center mr-3 mt-1">
                    <span className="text-primary-600 font-bold text-sm">✓</span>
                  </div>
                  <span>{t('services.cybersecurity.feature2')}</span>
                </li>
                <li className="flex items-start">
                  <div className="h-6 w-6 rounded-full bg-primary-100 flex items-center justify-center mr-3 mt-1">
                    <span className="text-primary-600 font-bold text-sm">✓</span>
                  </div>
                  <span>{t('services.cybersecurity.feature3')}</span>
                </li>
              </ul>
            ...
            <div className="flex justify-center items-center">
              <img 
                src="https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80" 
