            ...
            <div>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  ...
                  <span>{t('services.businessIntelligence.feature1')}</span>
                </li>
                <li className="flex items-start">
                  <div className="h-6 w-6 rounded-full bg-primary-100 flex items-center justify-center mr-3 mt-1">
                    <span className="text-primary-600 font-bold text-sm">✓</span>
                  </div>
                  <span>{t('services.businessIntelligence.feature2')}</span>
                </li>
                <li className="flex items-start">
                  <div className="h-6 w-6 rounded-full bg-primary-100 flex items-center justify-center mr-3 mt-1">
                    <span className="text-primary-600 font-bold text-sm">✓</span>
                  </div>
                  <span>{t('services.businessIntelligence.feature3')}</span>
                </li>
              </ul>
