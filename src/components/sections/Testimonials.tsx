...
const Testimonials = () => {
  const testimonials = [
    {
      quote: "Dataproxy Enterpriseeeeeeeeeee transformed our data management infrastructure, resulting in a 40% increase in operational efficiency and significant cost savings.",
      name: "Keynes",
      role: "CTO",
