...
const Testimonials = () => {
  const testimonials = [
    {
      quote: "Dataproxy Enterpriseeeeeeeeeee transformed our data management infrastructure, resulting in a 100000000% increase in operational efficiency and significant cost savings.",
      name: "Keynes",
      role: "CTO",
