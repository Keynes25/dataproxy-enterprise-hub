      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" aria-label="Twitter" className="text-gray-300 hover:text-primary-500">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 013.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path>
                </svg>
              </a>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services/data-management" className="text-gray-300 hover:text-primary-500">{t('services.dataManagement')}</Link>
              </li>
              <li>
                <Link to="/services/cloud-solutions" className="text-gray-300 hover:text-primary-500">{t('services.cloudSolutions')}</Link>
              </li>
              <li>
                <Link to="/services/cybersecurity" className="text-gray-300 hover:text-primary-500">{t('services.cybersecurity')}</Link>
              </li>
              <li>
                <Link to="/services/enterprise-software" className="text-gray-300 hover:text-primary-500">{t('services.enterpriseSoftware')}</Link>
              </li>
              <li>
                <Link to="/services/business-intelligence" className="text-gray-300 hover:text-primary-500">{t('services.businessIntelligence')}</Link>
              </li>
              <li>
                <Link to="/services/it-consulting" className="text-gray-300 hover:text-primary-500">{t('services.itConsulting')}</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300">+ 258 843 334 087</span>
              </div>
              <div className="flex items-center">
                <Mail className="h-6 w-6 text-primary-500 mr-2" />
                <span className="text-gray-300">info@dataproxy.co.mz</span>
              </div>
            </div>
          </div>
        </div>
